...
| Loại service | Vai trò | Ví dụ LMS |
|---|---|---|
...
```mermaid
graph TB
    subgraph Step1["Bước 1: Automation Candidates"]
        AC1["Xác thực\nngười dùng"]
        AC2["Quản lý\ncâu hỏi SQL"]
        AC3["Chấm bài\ntự động"]
        AC4["Quản lý\nbài tập/khóa học"]
    ...
    subgraph Step2["Bước 2: Service Layers"]
        TS["Task: Submission\nOrchestrator"]
        ES1["Entity: User"]
        ES2["Entity: Question"]
        ES3["Entity: Course"]
        US1["Utility: Auth"]
        US2["Utility: Notification"]
        CS1["Complicated:\nJudge/Sandbox"]
    end
    
    Step1 -->|"Phân loại"| Step2
    
    style Step1 fill:#E3F2FD
    style Step2 fill:#E8F5E9
```

*Hình 2.6b: Áp dụng Erl's Service-Oriented Analysis cho LMS — từ automation candidates đến service layers*
