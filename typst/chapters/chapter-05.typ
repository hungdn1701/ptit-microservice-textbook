...
#figure(
  image("/figures/ch05/fig-5-1.svg"),
  caption: [Hình 5.1: So sánh giao tiếp đồng bộ (coupled) và bất đồng bộ (decoupled)],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 5.1: Giao tiếp đồng bộ vs bất đồng bộ --- giải pháp cho ba vấn đề],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch05/fig-5-2.svg"),
  caption: [Hình 5.2: Point-to-Point (Queue) vs Publish/Subscribe (Topic)],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch05/fig-5-3.svg"),
  caption: [Hình 5.3: Ephemeral broker (message xóa sau ack) vs Durable broker (message vẫn còn)],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch05/fig-5-4.svg"),
  caption: [Hình 5.4: Kiến trúc RabbitMQ --- Exchange routing messages đến queues],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 5.2: Các concepts cốt lõi của RabbitMQ],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 5.3: Apache Kafka vs RabbitMQ --- so sánh toàn diện],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 5.4: Khi nào chọn Kafka, khi nào chọn RabbitMQ],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch05/fig-5-5.svg"),
  caption: [Hình 5.5: Kiến trúc Kafka --- Topic, Partitions và Consumer Group],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 5.5: Các concepts cốt lõi của Apache Kafka],
  kind: table,
  supplement: none,
  numbering: none
)
...
=== Flow hoàn chỉnh
#figure(
  image("/figures/ch05/fig-5-6.svg"),
  caption: [Hình 5.6: Luồng hoàn chỉnh --- từ submit qua Kafka đến kết quả qua WebSocket],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 5.6: Ba cấp độ delivery guarantee],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 5.7: Cấu trúc event --- metadata và payload],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 5.8: Bốn loại message trong event-driven architecture],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 5.9: Ba cách đưa kết quả đến client],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch05/fig-5-7.svg"),
  caption: [Hình 5.7: Kiến trúc 4-topic pipeline chấm bài trong Contest mode],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 5.10: Chi tiết các Kafka topics trong pipeline],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 5.11: Phân tích vấn đề Kafka pipeline trong LMS],
  kind: table,
  supplement: none,
  numbering: none
)
