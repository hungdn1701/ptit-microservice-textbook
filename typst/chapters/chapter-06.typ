...
#figure(
  image("/figures/ch06/fig-6-1.svg"),
  caption: [Hình 6.1: Two-Phase Commit --- Coordinator điều phối prepare và commit],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 6.1: Tại sao 2PC không phù hợp với microservices],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch06/fig-6-2.svg"),
  caption: [Hình 6.2: LMS Submit Saga --- chuỗi local transactions và compensating transactions],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 6.2: Ba loại transactions trong saga --- áp dụng cho LMS Submit Saga],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch06/fig-6-3.svg"),
  caption: [Hình 6.3: Choreography --- các service tự phối hợp qua events],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 6.3: Ưu và nhược điểm của Choreography],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch06/fig-6-4.svg"),
  caption: [Hình 6.4: Orchestration --- saga orchestrator điều phối toàn bộ flow],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 6.4: Ưu và nhược điểm của Orchestration],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 6.5: Choreography vs Orchestration --- khi nào dùng gì],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 6.6: Thiết kế compensation trong LMS],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch06/fig-6-5.svg"),
  caption: [Hình 6.5: Lost Updates anomaly --- hai saga ghi đè kết quả của nhau],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 6.7: Anomaly → Countermeasure --- áp dụng cho LMS],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 6.8: ACID (Monolith) vs BASE (Microservices)],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 6.9: Strategies cho UI khi chấp nhận eventual consistency],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch06/fig-6-6.svg"),
  caption: [Hình 6.6: Implicit Saga trong LMS --- choreography qua Kafka events],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 6.10: Phân tích vấn đề Submit Flow trong LMS],
  kind: table,
  supplement: none,
  numbering: none
)
