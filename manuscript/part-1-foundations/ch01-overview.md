...
## 1.3 Microservices — Sự tiến hóa tất yếu

### 1.3.1 Định nghĩa và đặc điểm
### 1.3.2 Những nguyên tắc then chốt
### 1.3.3 So sánh Monolith vs SOA vs Microservices

## 1.4 Khi nào nên dùng Microservices?
...
- Richardson, C. (2018). *Microservices.io*.
