...
#figure(
  image("/figures/ch07/fig-7-1.svg"),
  caption: [Hình 7.1: Ba hậu quả của shared database trong microservices],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch07/fig-7-2.svg"),
  caption: [Hình 7.2: Shared Database (đọc/ghi chung) vs Database-per-Service (data qua API)],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 7.1: Ba cấp độ tách database],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 7.2: Uber --- hành trình từ microservices spaghetti đến DOMA],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch07/fig-7-3.svg"),
  caption: [Hình 7.3: CAP Theorem --- CP (chọn consistency) vs AP (chọn availability) khi partition],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 7.3: CP vs AP cho từng service trong LMS],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch07/fig-7-4.svg"),
  caption: [Hình 7.4: Ba caching patterns --- Cache-Aside, Read-Through, Write-Behind],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 7.4: So sánh ba caching patterns],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 7.5: Chiến lược cache invalidation],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch07/fig-7-5.svg"),
  caption: [Hình 7.5: Năm chiến lược tách database --- từ ít rủi ro đến nhiều rủi ro],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 7.6: Migration path tách database cho LMS],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch07/fig-7-7.svg"),
  caption: [Hình 7.7: Truy cập dữ liệu xuyên service bằng API Call],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 7.7: Ưu và nhược điểm của API Call pattern],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch07/fig-7-8.svg"),
  caption: [Hình 7.8: Truy cập dữ liệu xuyên service bằng Data Duplication qua Event Pipeline],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 7.8: Ưu và nhược điểm của Data Duplication pattern],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch07/fig-7-9.svg"),
  caption: [Hình 7.9: API Composition pattern --- Gateway hoặc BFF gọi nhiều services và tổng hợp],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 7.9: Khi nào chấp nhận data duplication],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch07/fig-7-10.svg"),
  caption: [Hình 7.10: CQRS pattern --- tách command model (write) và query model (read)],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 7.10: Khi nào cần CQRS],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch07/fig-7-11.svg"),
  caption: [Hình 7.11: CQRS cho Leaderboard --- write side publish events, read side denormalized],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch07/fig-7-12.svg"),
  caption: [Hình 7.12: Event Sourcing --- lưu chuỗi events thay vì chỉ state hiện tại],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 7.11: Ưu và nhược điểm của Event Sourcing],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch07/fig-7-12b.svg"),
  caption: [Hình 7.12b: Snapshot pattern --- replay từ snapshot thay vì từ đầu],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 7.12: Chiến lược snapshot],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch07/fig-7-13.svg"),
  caption: [Hình 7.13: Projection Rebuilds --- tạo views mới từ events mà không cần migration],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 7.13: Event Store --- các công cụ phổ biến],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 7.14: Khi nào dùng Event Sourcing],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch07/fig-7-14.svg"),
  caption: [Hình 7.14: Kiến trúc dữ liệu hiện tại của LMS --- shared database là gap chính],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 7.15: Tổng hợp vấn đề data management trong LMS và chiến lược migration],
  kind: table,
  supplement: none,
  numbering: none
)
