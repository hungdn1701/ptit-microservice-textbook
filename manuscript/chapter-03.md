...
![Hình 3.1: Richardson Maturity Model — bốn cấp độ trưởng thành của REST API](../figures/ch03/fig-3-1.svg)
...
![Hình 3.2: Quy tắc schema evolution — thay đổi nào là breaking change](../figures/ch03/fig-3-2.svg)
...
![Hình 3.3: Pipeline từ code annotations đến Swagger UI và client SDK](../figures/ch03/fig-3-3.svg)
...
![Hình 3.4: DTO pattern — tách internal model và external contract](../figures/ch03/fig-3-4.svg)
...
![Hình 3.6b: Hexagonal Architecture cho Core Service trong LMS](../figures/ch03/fig-3-6b.svg)
