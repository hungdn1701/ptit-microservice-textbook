...
![Hình 10.1: Strangler Fig Pattern — dần thay thế monolith qua 3 giai đoạn](../figures/ch10/fig-10-1.svg)
...
![Hình 10.2: API Gateway làm seam cho Strangler Fig — client không biết route nào đến monolith, route nào đến service mới](../figures/ch10/fig-10-2.svg)
...
![Hình 10.3: Shared Database (coupled) vs Database-per-Service (decoupled)](../figures/ch10/fig-10-3.svg)
...
![Hình 10.4: Thứ tự thực hiện 5 chiến lược tách database](../figures/ch10/fig-10-4.svg)
...
![Hình 10.5: Dual-Write Pitfall — DB thành công nhưng event thất bại](../figures/ch10/fig-10-5.svg)
...
![Hình 10.6: Outbox Pattern — event ghi cùng transaction với business data](../figures/ch10/fig-10-6.svg)
...
![Hình 10.7: Anti-Corruption Layer — lớp dịch giữa service mới và legacy](../figures/ch10/fig-10-7.svg)
...
![Hình 10.8: Branch by Abstraction — migration an toàn qua feature flag](../figures/ch10/fig-10-8.svg)
...
![Hình 10.9: Parallel Run — chạy song song old và new logic, so sánh output](../figures/ch10/fig-10-9.svg)
...
![Hình 10.10: Migration Roadmap 4 phases — Quick Wins → Observability → Resilience → Decomposition](../figures/ch10/fig-10-10.svg)
...
![Hình 10.11: Decision Matrix — ưu tiên theo Impact × Effort](../figures/ch10/fig-10-11.svg)
