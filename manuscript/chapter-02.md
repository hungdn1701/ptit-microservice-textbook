...
>
> LMS hiện có Core Service và Assignment Service dùng chung database. Phân tích:
...
**Bảng 2.3:** Database-first vs Domain-first
...
*Hình 2.5: Context Map của hệ thống LMS — quan hệ giữa các bounded contexts*
...
*Hình 2.7: Bốn bounded contexts chính trong hệ thống LMS*
...
**Bảng 2.5:** Ánh xạ bounded context → service trong LMS
...
3. [2b] Chris Richardson, *Microservices Patterns*, 2nd Ed. — Ch.4: Loose Coupling, Dark Energy/Dark Matter Forces; Ch.7: Microservice Architecture; Ch.20: Assemblage Process
