...
#figure(
  image("/figures/ch02/fig-2-1.svg"),
  caption: [Hình 2.1: Conway's Law (thụ động) vs Inverse Conway Maneuver (chủ động)],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 2.1: Bốn kiểu team theo Team Topologies],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch02/fig-2-2.svg"),
  caption: [Hình 2.2: Mô hình Squad/Tribe/Chapter/Guild của Spotify],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 2.2: Cấu trúc tổ chức Spotify --- ý nghĩa cho microservices],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 2.3: Mười lực Dark Energy / Dark Matter],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch02/fig-2-3.svg"),
  caption: [Hình 2.3: Các building blocks trong DDD --- Aggregate, Entity, Value Object, Repository],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch02/fig-2-4.svg"),
  caption: [Hình 2.4: Cùng thuật ngữ "Submission" mang ý nghĩa khác nhau trong ba bounded context],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 2.4: Các kiểu quan hệ giữa bounded contexts],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch02/fig-2-5.svg"),
  caption: [Hình 2.5: Context Map của hệ thống LMS --- quan hệ giữa các bounded contexts],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch02/fig-2-6.svg"),
  caption: [Hình 2.6: Event Storming --- luồng từ Command đến Domain Event],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 2.7: Ba loại service theo Erl],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch02/fig-2-6b.svg"),
  caption: [Hình 2.6b: Áp dụng Erl's Service-Oriented Analysis cho LMS --- từ automation candidates đến service layers],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 2.8: Hai phương pháp phân tách service --- Erl Service-Oriented Analysis vs DDD],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch02/fig-2-7.svg"),
  caption: [Hình 2.7: Bốn bounded contexts chính trong hệ thống LMS],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 2.5: Ánh xạ bounded context → service trong LMS],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 2.6: Phân tích shared library --- cái gì nên shared, cái gì không],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch02/fig-2-8.svg"),
  caption: [Hình 2.8: Hướng tách shared library --- từ monolithic sang modular],
  kind: image,
  supplement: none,
  numbering: none
)
