...
- **references/case-study/business-domain.md**: Tài liệu nghiệp vụ KBLab LMS đầy đủ — 12 nghiệp vụ, 22 trade-offs, bảng ánh xạ nghiệp vụ ↔ chương sách
...
- **references/case-study/README.md**: Cập nhật naming DBLAB → KBLab, thêm liên kết đến `business-domain.md`
