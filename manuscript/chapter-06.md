...
![Hình 6.1: Two-Phase Commit — Coordinator điều phối prepare và commit](../figures/ch06/fig-6-1.svg)
...
![Hình 6.2: LMS Submit Saga — chuỗi local transactions và compensating transactions](../figures/ch06/fig-6-2.svg)
...
![Hình 6.3: Choreography — các service tự phối hợp qua events](../figures/ch06/fig-6-3.svg)
...
![Hình 6.4: Orchestration — saga orchestrator điều phối toàn bộ flow](../figures/ch06/fig-6-4.svg)
...
![Hình 6.5: Lost Updates anomaly — hai saga ghi đè kết quả của nhau](../figures/ch06/fig-6-5.svg)
...
![Hình 6.6: Implicit Saga trong LMS — choreography qua Kafka events](../figures/ch06/fig-6-6.svg)
