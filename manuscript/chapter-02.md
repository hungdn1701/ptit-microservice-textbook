...
![Hình 2.1: Conway's Law (thụ động) vs Inverse Conway Maneuver (chủ động)](../figures/ch02/fig-2-1.svg)
...
![Hình 2.2: Mô hình Squad/Tribe/Chapter/Guild của Spotify](../figures/ch02/fig-2-2.svg)
...
![Hình 2.3: Các building blocks trong DDD — Aggregate, Entity, Value Object, Repository](../figures/ch02/fig-2-3.svg)
...
![Hình 2.4: Cùng thuật ngữ "Submission" mang ý nghĩa khác nhau trong ba bounded context](../figures/ch02/fig-2-4.svg)
...
![Hình 2.5: Context Map của hệ thống LMS — quan hệ giữa các bounded contexts](../figures/ch02/fig-2-5.svg)
...
![Hình 2.6: Event Storming — luồng từ Command đến Domain Event](../figures/ch02/fig-2-6.svg)
...
![Hình 2.6b: Áp dụng Erl's Service-Oriented Analysis cho LMS — từ automation candidates đến service layers](../figures/ch02/fig-2-6b.svg)
...
![Hình 2.7: Bốn bounded contexts chính trong hệ thống LMS](../figures/ch02/fig-2-7.svg)
...
![Hình 2.8: Hướng tách shared library — từ monolithic sang modular](../figures/ch02/fig-2-8.svg)
