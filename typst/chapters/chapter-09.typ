...
#figure(
  image("/figures/ch09/fig-9-1.svg"),
  caption: [Hình 9.1: Monolith (1 điểm bảo vệ) vs Microservices (N điểm bảo vệ)],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 9.1: Thách thức bảo mật trong microservices],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch09/fig-9-2.svg"),
  caption: [Hình 9.2: Defense in Depth --- bảo vệ nhiều lớp từ network đến data],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 9.2: So sánh không có mTLS và có mTLS],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 9.3: Các cấp độ lưu trữ secrets],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch09/fig-9-3.svg"),
  caption: [Hình 9.3: Cấu trúc JWT --- Header, Payload, Signature],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 9.4: Ba phần của JWT --- nội dung và ví dụ],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 9.5: HS256 (symmetric) vs RS256 (asymmetric)],
  kind: table,
  supplement: none,
  numbering: none
)
...
=== JWT Flow trong LMS
#figure(
  image("/figures/ch09/fig-9-4.svg"),
  caption: [Hình 9.4: JWT Flow trong LMS --- login, token generation, và subsequent requests],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch09/fig-9-5b.svg"),
  caption: [Hình 9.5b: Token Refresh & Rotation flow --- access token mới + refresh token mới],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch09/fig-9-5.svg"),
  caption: [Hình 9.5: Dual Validation --- full validation (Auth) vs claims-only (internal services)],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 9.6: Ba loại validation trong LMS],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 9.7: Ba phương thức đăng nhập trong LMS],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 9.8: RBAC --- vai trò và permissions trong LMS],
  kind: table,
  supplement: none,
  numbering: none
)
...
=== Role Hierarchy
#figure(
  image("/figures/ch09/fig-9-6.svg"),
  caption: [Hình 9.6: Role Hierarchy --- ADMIN inherits LECTURER inherits STUDENT],
  kind: image,
  supplement: none,
  numbering: none
)
...
=== Tổng quan
#figure(
  image("/figures/ch09/fig-9-7.svg"),
  caption: [Hình 9.7: Kiến trúc bảo mật tổng thể của LMS],
  kind: image,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 9.9: Phân tích bảo mật toàn diện hệ thống LMS],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  ...
  caption: [Bảng 9.10: Chiến lược Secret Management --- từ cơ bản đến enterprise],
  kind: table,
  supplement: none,
  numbering: none
)
...
#figure(
  image("/figures/ch09/fig-9-8.svg"),
  caption: [Hình 9.8: Vault Dynamic Secrets --- credentials tạm thời, tự động xoay vòng],
  kind: image,
  supplement: none,
  numbering: none
)
