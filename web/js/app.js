(function() {
  "use strict";
    ...
    const patterns = [
      ...
      { ch: 4, icon: SVG_ICONS.code, name: 'Circuit Breaker', file: 'patterns/security/circuit-breaker.html', cat: 'security' },
      ...
      { ch: 8, icon: SVG_ICONS.code, name: 'Rate Limiting', file: 'patterns/security/rate-limiting.html', cat: 'security' },
