...
![Hình 7.1: Ba hậu quả của shared database trong microservices](../figures/ch07/fig-7-1.svg)
...
![Hình 7.2: Shared Database (đọc/ghi chung) vs Database-per-Service (data qua API)](../figures/ch07/fig-7-2.svg)
...
![Hình 7.3: CAP Theorem — CP (chọn consistency) vs AP (chọn availability) khi partition](../figures/ch07/fig-7-3.svg)
...
![Hình 7.5: Năm chiến lược tách database — từ ít rủi ro đến nhiều rủi ro](../figures/ch07/fig-7-5.svg)
...
![Hình 7.7: Truy cập dữ liệu xuyên service bằng API Call](../figures/ch07/fig-7-7.svg)
...
![Hình 7.8: Truy cập dữ liệu xuyên service bằng Data Duplication qua Event Pipeline](../figures/ch07/fig-7-8.svg)
...
![Hình 7.9: API Composition pattern — Gateway hoặc BFF gọi nhiều services và tổng hợp](../figures/ch07/fig-7-9.svg)
...
![Hình 7.10: CQRS pattern — tách command model (write) và query model (read)](../figures/ch07/fig-7-10.svg)
...
![Hình 7.11: CQRS cho Leaderboard — write side publish events, read side denormalized](../figures/ch07/fig-7-11.svg)
...
![Hình 7.12: Event Sourcing — lưu chuỗi events thay vì chỉ state hiện tại](../figures/ch07/fig-7-12.svg)
...
![Hình 7.12b: Snapshot pattern — replay từ snapshot thay vì từ đầu](../figures/ch07/fig-7-12b.svg)
...
![Hình 7.13: Projection Rebuilds — tạo views mới từ events mà không cần migration](../figures/ch07/fig-7-13.svg)
...
![Hình 7.14: Kiến trúc dữ liệu hiện tại của LMS — shared database là gap chính](../figures/ch07/fig-7-14.svg)
