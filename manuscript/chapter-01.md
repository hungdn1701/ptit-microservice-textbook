...
```mermaid
graph TD
    FF["🎯 Fast Flow"] --- D["DevOps"]
    FF --- TT["Team Topologies"]
    FF --- A["Architecture"]
    
    D -->|"enables"| CD["Continuous Delivery<br/>Small batch sizes<br/>Automated pipeline"]
    TT -->|"enables"| SA["Stream-aligned teams<br/>Team autonomy<br/>Minimal hand-offs"]
    A -->|"enables"| LC["Loose coupling<br/>Independent deployability<br/>Fast deployment pipeline"]
    
    style FF fill:#FF6F00,color:white
    style D fill:#1565C0,color:white
    style TT fill:#2E7D32,color:white
    style A fill:#6A1B9A,color:white
```
...
**Bảng 1.4:** Patchwork Monolith vs Modular Monolith
...
*Hình 1.5: Con đường từ Patchwork Monolith đến Microservices*
...
*Hình 1.6: Decision Framework — ba câu hỏi trước khi chọn microservices*
