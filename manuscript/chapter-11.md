...
![Hình 11.2: Ba trụ cột của Observability — Logs, Metrics, Traces](../figures/ch11/fig-11-2.svg)
...
![Hình 11.3: Logs phân tán (manual debug) vs Logs tập trung — Search một nơi](../figures/ch11/fig-11-3.svg)
...
![Hình 11.5: Truyền Correlation ID xuyên suốt request, kể cả qua Kafka](../figures/ch11/fig-11-5.svg)
...
![Hình 11.6: Gantt chart của một Trace — hiển thị timing cho từng Span](../figures/ch11/fig-11-6.svg)
...
![Hình 11.7: Mối quan hệ giữa SLI, SLO và SLA](../figures/ch11/fig-11-7.svg)
...
![Hình 11.8: User Activity Tracking pipeline qua Kafka](../figures/ch11/fig-11-8.svg)
