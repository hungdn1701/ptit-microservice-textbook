...
#strong[Bảng 1.1:] Các biểu hiện khi monolith đạt đến giới hạn
...
#strong[Bảng 1.2:] Tám nguyên lý hướng dịch vụ --- SOA truyền thống vs Microservices
...
#strong[Bảng 1.3:] So sánh SOA truyền thống và Microservices
...
#strong[Bảng 1.4:] DORA Metrics --- So sánh Elite vs Low Performers
...
#strong[Bảng 1.5:] Lợi ích của kiến trúc microservices
...
#strong[Bảng 1.6:] Chi phí và thách thức của microservices
...
#strong[Bảng 1.7:] Ánh xạ bài toán kỹ thuật KBLab LMS theo chương
...
#strong[Bảng 1.8:] Năm quyết định kiến trúc KBLab muốn làm lại
